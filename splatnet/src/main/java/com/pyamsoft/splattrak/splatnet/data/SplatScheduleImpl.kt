...
internal data class SplatScheduleImpl internal constructor(
    private val regular: SplatBattle,
    private val league: SplatBattle,
    private val ranked: SplatBattle
) : SplatSchedule {

    private val battleList by lazy(LazyThreadSafetyMode.NONE) {
        listOf(regular, ranked, league)
    }
