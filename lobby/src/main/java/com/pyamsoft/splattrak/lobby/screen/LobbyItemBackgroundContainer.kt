...
import com.pyamsoft.splattrak.lobby.databinding.LobbyListItemBackgroundContainerBinding
...
class LobbyItemBackgroundContainer @Inject internal constructor(
    ...
    parent: ViewGroup,
) : BaseUiView<LobbyItemViewState, LobbyItemViewEvent, LobbyListItemBackgroundContainerBinding>(
    parent) {

    override val layoutRoot by boundView { lobbyItemBackgroundContainer }

    override val viewBinding = LobbyListItemBackgroundContainerBinding::inflate
